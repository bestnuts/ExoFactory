...
data modify storage exo main.instance.value.name set value "save"
data modify storage exo main.instance.value.list set from storage exo main.instance.origin.data.control_data.storage.type
