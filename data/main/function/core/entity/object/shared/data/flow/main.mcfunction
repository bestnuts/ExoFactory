...
execute unless score #transmitter.amount V matches 0 run function main:core/entity/object/shared/data/flow/logic/last_amount with storage exo main.instance.value