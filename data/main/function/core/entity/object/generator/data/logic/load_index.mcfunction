...
$execute store result score #generator.$(type).storage.output V run data get storage exo main.instance.control_data.storage.$(type).output
$execute store result score #generator.$(type).storage.save V run data get storage exo main.instance.control_data.storage.$(type).save
