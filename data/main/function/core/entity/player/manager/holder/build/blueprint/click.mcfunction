...
data modify storage exo main.instance.build_data.model set from storage exo main.instance.player.item.minecraft:item_model
execute store result storage exo main.instance.build_data.pos.y int 1 run scoreboard players get #blueprint.pos.y V
data modify storage exo main.instance.control_data set from storage exo main.instance.player.item.minecraft:custom_data.data.control_data
data modify storage exo main.instance.info_data set from storage exo main.instance.player.item.minecraft:custom_data.data.info_data
