...
execute as @n[type=item_display,tag=new] run function main:core/entity/player/manager/holder/build/blueprint/logic/create/entity_setter with storage exo main.instance.build_data