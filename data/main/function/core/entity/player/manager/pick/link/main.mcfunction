...
execute if function main:core/entity/player/manager/pick/link/data/check_linked run return run function main:core/entity/player/manager/pick/link/data/init_font
