...
execute if entity @s[distance=..3] as @e[type=item_display,tag=entity.info,sort=nearest] if function api:private/condition/entity/info/distance_check run function main:core/entity/player/pick/as_info
