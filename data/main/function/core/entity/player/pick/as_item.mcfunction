...
execute if entity @s[tag=entity.object] run data modify storage exo main.instance.info_data set from entity @s data.info_data
execute at @s run summon text_display ~ ~0.5 ~ {Tags:["display.info","new"],billboard:"center",see_through:0b,alignment:"center",background:-4038388}
