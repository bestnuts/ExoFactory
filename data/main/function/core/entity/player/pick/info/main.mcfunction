...
execute as @p[tag=this.origin.player] run function main:core/entity/player/pick/info/player_setter
...
execute as @n[type=text_display,tag=new] run function main:core/entity/player/pick/info/entity_setter