execute if score #storage.looking_object.id V matches 0 if score #player.linked_object V matches 0 run scoreboard players operation #player.linked_object V = @s id.object
execute unless score #storage.looking_object.id V = #player.linked_object V run scoreboard players operation #player.linked_object V = @s id.object
...
execute store result storage exo main.instance.storage.data.looking_object.id int 1 run scoreboard players get #player.linked_object V
scoreboard players operation #storage.old.looking_object.id V = #storage.looking_object.id V
scoreboard players operation #storage.looking_object.id V = #player.linked_object V
