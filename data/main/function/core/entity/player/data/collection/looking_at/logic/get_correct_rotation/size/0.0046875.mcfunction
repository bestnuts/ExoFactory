...
execute if predicate api:entity/player/raycasting/get_correct_rotation positioned as @n[type=interaction,tag=raycasting.correct_rotation] positioned ~-0.001171875 ~ ~-0.001171875 run function main:core/entity/player/data/collection/looking_at/logic/get_correct_rotation/size/0.00234375
