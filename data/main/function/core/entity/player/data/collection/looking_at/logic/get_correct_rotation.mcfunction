...
execute if predicate api:entity/player/raycasting/get_correct_rotation run function main:core/entity/player/data/collection/looking_at/logic/get_correct_rotation/start
