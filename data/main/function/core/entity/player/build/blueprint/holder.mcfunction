...
execute if entity @s[tag=player.blueprint] run function main:core/entity/player/build/blueprint/logic/modify_blueprint with storage exo main.instance.pos