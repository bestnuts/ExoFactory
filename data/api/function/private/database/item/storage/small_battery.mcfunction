...
control_data:{run:"default_storage",process:{type:["electric"],electric:{output:100,save:5000,efficiency:1,transmitter:[]}},storage:{type:["electric"],electric:{is_input:true,is_output:true,output:0,save:0,transmitter:[]}}},\
