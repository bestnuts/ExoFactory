...
control_data:{run:"default_storage",process:{type:["electric"],electric:{output:100,save:5000,efficiency:1}},storage:{type:["electric"],electric:{input:true,output:0,save:0}}},\
